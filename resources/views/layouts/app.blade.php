...
<head>
    ...
    <!-- Start Moltarn Bootstrap Templete Link Copy -->
    <!-- Base Css Files -->
    ...
    <!-- Close Moltarn Bootstrap Templete Link Copy -->
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.html" class="logo"><i class="{{-- md md-terrain --}}"></i> <span>Apk199 </span></a>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="">
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="dropdown">
                                    <a href="" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true"><img src="{{ URL::to('public/admin/images/logo-2.jpg') }}" alt="user-img" class="img-circle"> </a>
            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            {{-- <li>
                                <a href="index.html" class="waves-effect active"><i class="fas fa-home"></i><span> <b style="font-size: 16px; color: #317eeb;"> Dashboard </b></span></a>
                            </li>

                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="fas fa-shipping-fast"></i><span> <b style="font-size: 16px;color: #317eeb;">Supplier</b> </span><span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="{{ route('add.supplier') }}"><b style="font-size: 13px;color: #317eeb;"> Add Supplier</b></a></li>
                                    <li><a href="{{ route('all.supplier') }}"><b style="font-size: 13px;color: #317eeb;"> All Supplier</b></a></li>
